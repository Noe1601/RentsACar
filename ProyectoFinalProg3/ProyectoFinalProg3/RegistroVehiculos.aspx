        ...
        <div class="container">
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
                ...
                <asp:TextBox ID="TextBox6" class="form-control" placeholder="Año" runat="server"></asp:TextBox>
                </div>

                <div class="col">
                <asp:Label ID="Label15" runat="server" Text="Color del vehiculo"></asp:Label>
                <asp:TextBox ID="TextBox14" class="form-control" placeholder="Color" runat="server"></asp:TextBox>                </div>
                </div>
            </div>

            <div class="form-group">
                <asp:Label ID="Label6" runat="server" Text="Marca del vehiculo"></asp:Label>
                <asp:DropDownList class="form-control" ID="DropDownList1" runat="server"></asp:DropDownList>
            </div>

            
            <div class="form-group">
                <asp:Label ID="Label5" runat="server" Text="Precio por dia"></asp:Label>
             ...
             <div class="form-group row">
                ...
                <asp:TextBox ID="TextBox3" class="form-control" placeholder="Capacidad" runat="server"></asp:TextBox>
                </div>

                <div class="col">
                     <asp:Label ID="Label4" runat="server" Text="Capacidad de pasajeros"></asp:Label>
                <asp:TextBox ID="TextBox4" class="form-control" placeholder="Pasajeros" runat="server"></asp:TextBox>
                </div>
                </div>
            </div>
             ...
             <div class="form-group row">
                ...
                <asp:TextBox ID="TextBox7" class="form-control" placeholder="Matricula" runat="server"></asp:TextBox>
                </div>

                <div class="col">
                     <asp:Label ID="Label8" runat="server" Text="No. Seguro del vehiculo"></asp:Label>
                <asp:TextBox ID="TextBox8" class="form-control" placeholder="Numero de seguro" runat="server"></asp:TextBox>
                </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox11" class="form-control" placeholder="Foto" runat="server"></asp:TextBox>
            </div>

            <div class="form-group">
                <asp:Label ID="Label12" runat="server" Text="Marca del vehiculo"></asp:Label>
                <asp:TextBox ID="TextBox12" class="form-control" placeholder="Marca" runat="server"></asp:TextBox>
            </div>
            ...
            <div class="form-group row">
                ...
                <asp:TextBox ID="TextBox9" class="form-control" placeholder="latitud" runat="server"></asp:TextBox>
                </div>

                <div class="col">
                     <asp:Label ID="Label10" runat="server" Text="Longitud"></asp:Label>
                <asp:TextBox ID="TextBox10" class="form-control" placeholder="longitud" runat="server"></asp:TextBox>
                </div>
                </div>
            </div>
    
            <asp:Button ID="Button1" class="btn btn-primary btn-block mt-4 mb-4" runat="server" Text="Registrar vehiculo" />
