    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:Label ID="Label13" runat="server" Text="Label">
              ...
              No se registo el cliente, intentelo de nuevo.
            </div>
            </asp:Label>
            ...
            <hr />
             ...
             <div class="form-group row">
                ...
                <asp:TextBox ID="TextBox8" class="form-control" placeholder="Ingrese su foto licencia" runat="server"></asp:TextBox>
                   ...
                   <asp:Button ID="Button1" class="btn btn-primary btn-block mt-4 mb-4" runat="server" Text="Registrarme" OnClick="Button1_Click" />
            </div>
